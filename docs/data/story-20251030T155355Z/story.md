# Огни Сантьяго / Сторигейм / КвестБук

_Источник: https://quest-book.ru/online/game17030/_
 ...
 <SCRIPT src="/online/player/mitril/libs//jsiqapi.min.js"></SCRIPT>
		...
		$(document).ready(function () {
			window.playerInfo = {
				...
				id: -1,
				game_id: 17030,
				testuid: 'f91d353d85773446074a0b6db85b8ab3'
			};
			jsIQ.init('data/');
		});
...
- [Создать](https://quest-book.ru/online/game17030/) → `17030`
- [Ночной режим](https://quest-book.ru/online/game17030/) → `17030`
- [Дневной режим](https://quest-book.ru/online/game17030/) → `17030`
- [Войдите под своим именем или зарегистрируйтесь](https://quest-book.ru/online/game17030/) → `17030`
- [Начать заново](https://quest-book.ru/online/game17030/) → `17030`
- [Перейти к обсуждению](https://quest-book.ru/online/game17030/) → `17030`
- [Читать этот сторигейм в Telegram](https://quest-book.ru/online/game17030/) → `17030`
- [Игроки](https://quest-book.ru/online/game17030/) → `17030`
- [Чат игры](https://quest-book.ru/online/game17030/) → `17030`
- [В редактор](https://quest-book.ru/online/game17030/) → `17030`
- [Ошибка!](https://quest-book.ru/online/game17030/) → `17030`
- [#](https://quest-book.ru/online/game17030/) → `17030`
